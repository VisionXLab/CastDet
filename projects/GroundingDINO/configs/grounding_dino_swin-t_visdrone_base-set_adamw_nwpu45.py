...
dior_classes = ('airplane', 'baseballfield', 'bridge', 'chimney', 'dam',
    ...
    dataset=dict(
        ...
        datasets=[
            ...
            dict(
                ...
                ann_file='annotations/nwpu45_unlabeled_with_gdino_pseudos_swin-t_adamw_top1.json',
                data_prefix=dict(img='NWPU-RESISC45/'),
                backend_args=_base_.backend_args,
                pipeline=nwpu_train_pipeline,
                return_classes=True)
        ]
        ))
...
load_from="work_dirs/grounding_dino_swin-t_visdrone_base-set_adamw/iter_20000.pth"
